...
class LandMarkTest {
    ...
    // To test the getter of landmarkId

    @Test
    @DisplayName("getLandmarkId")
    void getLandmarkId() {
        assertNotNull(landmarkObj.getLandmarkId());
        assertEquals("1macD234", landmarkObj.getLandmarkId());
    }
    ...
    void  setLandmarkId() {
        ...
        assertTrue(landmarkObj.getLandmarkId() == landmarkId);
        assertEquals(landmarkObj.getLandmarkId(),landmarkId);
    }

    // To test the getter of image

    @Test
    @DisplayName("getImage")
    void getImage() {
        assertNotNull(landmarkObj.getImage());
        assertEquals("islandbotlargethin.png", landmarkObj.getImage());
    }
    ...
    void setImage() {
        ...
        assertTrue(landmarkObj.getImage() == image);
        assertEquals(landmarkObj.getImage(),image);
    }

    // To test the getter of Gps points

    @Test
    @DisplayName("getGpsPoints")
    void getGpsPoints() {
        assertNotNull(landmarkObj.getGpsPoints());
        assertEquals(gpsObj, landmarkObj.getGpsPoints());
    }
    ...
    // To test the getter of scale

    @Test
    @DisplayName("getScale")
    void getScale() {
        assertNotNull(landmarkObj.getScale());
        assertEquals("stretch",landmarkObj.getScale());
    }
    ...
    void setScale() {
        ...
        assertTrue(landmarkObj.getScale() == scale);
        assertEquals(landmarkObj.getScale(),scale);
    }

    // To test the getter of anchor

    @Test
    @DisplayName("getAnchor")
    void getAnchor() {
        assertNotNull(landmarkObj.getAnchor());
        assertEquals("sw", landmarkObj.getAnchor());
    }
    ...
    void setAnchor() {
        ...
        assertTrue(landmarkObj.getAnchor() == anchor);
